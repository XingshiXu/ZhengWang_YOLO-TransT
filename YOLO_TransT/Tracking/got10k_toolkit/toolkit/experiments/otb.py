...
class ExperimentOTB(object):
    r"""Experiment pipeline and evaluation got10k_toolkit for OTB2015 dataset.
    
    Args:
        root_dir (string): Root directory of OTB2015 dataset.
    ...
    def __init__(self, root_dir, version=2015,
        ...
        self.result_dir = os.path.join(result_dir, 'OTB2015' + str(version))
        self.report_dir = os.path.join(report_dir, 'OTB2015' + str(version))
